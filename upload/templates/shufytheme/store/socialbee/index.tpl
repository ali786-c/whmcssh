<div class="landing-page bg-white social-bee full__with__section">
	<div class="container">
		<div class="hero">
			<img style="max-width: 190px" src="{$WEB_ROOT}/assets/img/marketconnect/socialbee/SocialBeeLogo.png" alt="SocialBee">
			<div class="mb-20 text-center">
				<h6 class="coodiv-text-8 mb-0">{lang key='store.socialbee.header'}</h6>
				<p class="coodiv-text-9 font-weight-400">{lang key='store.socialbee.hero'}</p>
			</div>
		</div>
	</div>
	...
	<div class="planner">
		<div class="container">
			<img class="mx-auto" src="{$WEB_ROOT}/assets/img/marketconnect/socialbee/planner.png" alt="planner">
		</div>
	</div>
	...
	<div class="lp-container">
		...
		<div class="faq w-100">
			<div class="text-center">
				<h2 class="coodiv-text-8 mb-0">{lang key='store.faq'}</h2>
				<p class="coodiv-text-9 font-weight-400">{lang key='store.socialbee.faq.unanswered'}</p>
			</div>
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-8 col-12">
						<div class="accordion coodiv__faq__accordions__wrapper mt-15" id="accordionFaqsection">
							<div class="coodiv__faq__accordions__item">
								<div class="coodiv__faq__accordions__item__header" id="heading-1">
									<button class="btn-reset coodiv-text-10 font-weight-700 accordion-trigger arrow-icon w-100" type="button" data-toggle="collapse" data-target="#collapse-1" aria-expanded="false" aria-controls="collapse-1">
										{lang key='store.socialbee.faq.q1'}
									</button>
								</div>
								<div id="collapse-1" class="collapse coodiv__faq__accordions__item__body" aria-labelledby="heading-1" data-parent="#accordionFaqsection">
							...
							<div class="coodiv__faq__accordions__item">
								<div class="coodiv__faq__accordions__item__header" id="heading-2">
									<button class="btn-reset coodiv-text-10 font-weight-700 accordion-trigger arrow-icon w-100" type="button" data-toggle="collapse" data-target="#collapse-2" aria-expanded="false" aria-controls="collapse-2">
										{lang key='store.socialbee.faq.q2'}
									</button>
								</div>
								<div id="collapse-2" class="collapse coodiv__faq__accordions__item__body" aria-labelledby="heading-2" data-parent="#accordionFaqsection">
									<div class="coodiv-text-11 font-weight-400">
							...
							<div class="coodiv__faq__accordions__item">
								<div class="coodiv__faq__accordions__item__header" id="heading-3">
									<button class="btn-reset coodiv-text-10 font-weight-700 accordion-trigger arrow-icon w-100" type="button" data-toggle="collapse" data-target="#collapse-3" aria-expanded="false" aria-controls="collapse-3">
										{lang key='store.socialbee.faq.q3'}
									</button>
								</div>
								<div id="collapse-3" class="collapse coodiv__faq__accordions__item__body" aria-labelledby="heading-3" data-parent="#accordionFaqsection">
									<div class="coodiv-text-11 font-weight-400">
							...
							<div class="coodiv__faq__accordions__item">
								<div class="coodiv__faq__accordions__item__header" id="heading-4">
									<button class="btn-reset coodiv-text-10 font-weight-700 accordion-trigger arrow-icon w-100" type="button" data-toggle="collapse" data-target="#collapse-4" aria-expanded="false" aria-controls="collapse-4">
										{lang key='store.socialbee.faq.q4'}
									</button>
								</div>
								<div id="collapse-4" class="collapse coodiv__faq__accordions__item__body" aria-labelledby="heading-4" data-parent="#accordionFaqsection">
									<div class="coodiv-text-11 font-weight-400">
										<p>
							...
							<div class="coodiv__faq__accordions__item">
								<div class="coodiv__faq__accordions__item__header" id="heading-5">
									<button class="btn-reset coodiv-text-10 font-weight-700 accordion-trigger arrow-icon w-100" type="button" data-toggle="collapse" data-target="#collapse-5" aria-expanded="false" aria-controls="collapse-5">
										{lang key='store.socialbee.faq.q5'}
									</button>
								</div>
								<div id="collapse-5" class="collapse coodiv__faq__accordions__item__body" aria-labelledby="heading-5" data-parent="#accordionFaqsection">
									<div class="coodiv-text-11 font-weight-400">
										{lang key='store.socialbee.faq.a5'}
									</div>
								</div>
							</div>
