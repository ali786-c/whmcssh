	...
	<div class="row justify-content-center mb-10">
		<div class="col-md-8 col-12 text-center">
			<h6 class="coodiv-text-10 font-weight-300 sub-color text-uppercase">
				{if $coodivhomepagesettings.themehomepagesettingservicesfeaturestagline|default:'' == null}
					{$LANG.shufytheme.homepage__features__title}
				{else}
					{$coodivhomepagesettings.themehomepagesettingservicesfeaturestagline|default:''}
				{/if}
			</h6>
			<h6 class="coodiv-text-6 font-weight-700">
				{if $coodivhomepagesettings.themehomepagesettingservicesfeaturestitle|default:'' == null}
					{$LANG.shufytheme.homepage__features__subtitle}
				{else}
					{$coodivhomepagesettings.themehomepagesettingservicesfeaturestitle|default:''}
				{/if}
			</h6>
			<p class="coodiv-text-9 font-weight-300 mt-1">
				{if $coodivhomepagesettings.themehomepagesettingservicesfeaturessubtitle|default:'' == null}
					{$LANG.shufytheme.homepage__features__description}
				{else}
					{$coodivhomepagesettings.themehomepagesettingservicesfeaturessubtitle|default:''}
				{/if}
			</p>
		</div>
	</div>
	<div class="row justify-content-start">
		{if $coodivhomepagesettings.themehomepagesettingservicesfeaturessecond|default:''=='activated' || $coodivhomepagesettings.id|default:'' != '1'}
			<div class="col-lg col-md-6 col-12">
				<div class="homepage__main__features__box wow fadeIn text-lg-left text-center">
					...
					{if $coodivhomepagesettings.themehomepagesettingservicesfeaturessecondicon|default:'' == null}
					...
					{else}
						<img class="icon" src="{$coodivhomepagesettings.themehomepagesettingservicesfeaturessecondicon|default:''}" alt="features illusration" />
					{/if}
					</div>
					<h5 class="coodiv-text-8 font-weight-700">
						{if $coodivhomepagesettings.themehomepagesettingservicesfeaturessecondtitle|default:'' == null}
							{$LANG.shufytheme.homepage__features__highspeed__title}
						{else}
							{$coodivhomepagesettings.themehomepagesettingservicesfeaturessecondtitle|default:''}
						{/if}
					</h5>
					<p class="coodiv-text-11 font-weight-300">
						{if $coodivhomepagesettings.themehomepagesettingservicesfeaturesseconddescription|default:'' == null}
							{$LANG.shufytheme.homepage__features__highspeed__description}
						{else}
							{$coodivhomepagesettings.themehomepagesettingservicesfeaturesseconddescription|default:''}
						{/if}
					</p>
				</div>
			</div>
		...
		{if $coodivhomepagesettings.themehomepagesettingservicesfeaturesthird|default:''=='activated' || $coodivhomepagesettings.id|default:'' != '1'}
			<div class="col-lg col-md-6 col-12">
				<div class="homepage__main__features__box wow fadeIn text-lg-left text-center">
					<div class="homepage__main__features__box__illustration mx-auto mx-lg-0">
					{if $coodivhomepagesettings.themehomepagesettingservicesfeaturesthirdicon|default:'' == null}
					...
					{else}
						<img class="icon" src="{$coodivhomepagesettings.themehomepagesettingservicesfeaturesthirdicon|default:''}" alt="features illusration" />
					{/if}
					</div>
					<h5 class="coodiv-text-8 font-weight-700">
						{if $coodivhomepagesettings.themehomepagesettingservicesfeaturesthirdtitle|default:'' == null}
							{$LANG.shufytheme.homepage__features__uptime__title}
						{else}
							{$coodivhomepagesettings.themehomepagesettingservicesfeaturesthirdtitle|default:''}
						{/if}
					</h5>
					<p class="coodiv-text-11 font-weight-300">
						{if $coodivhomepagesettings.themehomepagesettingservicesfeaturesthirddescription|default:'' == null}
							{$LANG.shufytheme.homepage__features__uptime__description}
						{else}
							{$coodivhomepagesettings.themehomepagesettingservicesfeaturesthirddescription|default:''}
						{/if}
					</p>
				</div>
			</div>
		...
		{if $coodivhomepagesettings.themehomepagesettingservicesfeaturesfourth|default:''=='activated' || $coodivhomepagesettings.id|default:'' != '1'}
			<div class="col-lg col-md-6 col-12">
				<div class="homepage__main__features__box wow fadeIn text-lg-left text-center">
					<div class="homepage__main__features__box__illustration mx-auto mx-lg-0">
					{if $coodivhomepagesettings.themehomepagesettingservicesfeaturesfourthicon|default:'' == null}
					...
					{else}
						<img class="icon" src="{$coodivhomepagesettings.themehomepagesettingservicesfeaturesfourthicon|default:''}" alt="features illusration" />
					{/if}
					</div>
					<h5 class="coodiv-text-8 font-weight-700">
						{if $coodivhomepagesettings.themehomepagesettingservicesfeaturesfourthtitle|default:'' == null}
							{$LANG.shufytheme.homepage__features__secure__title}
						{else}
							{$coodivhomepagesettings.themehomepagesettingservicesfeaturesfourthtitle|default:''}
						{/if}
					</h5>
					<p class="coodiv-text-11 font-weight-300">
						{if $coodivhomepagesettings.themehomepagesettingservicesfeaturesfourthdescription|default:'' == null}
							{$LANG.shufytheme.homepage__features__secure__description}
						{else}
							{$coodivhomepagesettings.themehomepagesettingservicesfeaturesfourthdescription|default:''}
						{/if}
					</p>
				</div>
			</div>
		...
		{if $coodivhomepagesettings.themehomepagesettingservicesfeaturesfivth|default:''=='activated' || $coodivhomepagesettings.id|default:'' != '1'}
			<div class="col-lg col-md-6 col-12">
				<div class="homepage__main__features__box wow fadeIn text-lg-left text-center">
					<div class="homepage__main__features__box__illustration mx-auto mx-lg-0">
					{if $coodivhomepagesettings.themehomepagesettingservicesfeaturesfivthicon|default:'' == null}
					...
					{else}
						<img class="icon" src="{$coodivhomepagesettings.themehomepagesettingservicesfeaturesfivthicon|default:''}" alt="features illusration" />
					{/if}
					</div>
					<h5 class="coodiv-text-8 font-weight-700">
						{if $coodivhomepagesettings.themehomepagesettingservicesfeaturesfivthtitle|default:'' == null}
							{$LANG.shufytheme.homepage__features__redundant__title}
						{else}
							{$coodivhomepagesettings.themehomepagesettingservicesfeaturesfivthtitle|default:''}
						{/if}
					</h5>
					<p class="coodiv-text-11 font-weight-300">
						{if $coodivhomepagesettings.themehomepagesettingservicesfeaturesfivthdescription|default:'' == null}
							{$LANG.shufytheme.homepage__features__redundant__description}
						{else}
							{$coodivhomepagesettings.themehomepagesettingservicesfeaturesfivthdescription|default:''}
						{/if}
					</p>
				</div>
			</div>
