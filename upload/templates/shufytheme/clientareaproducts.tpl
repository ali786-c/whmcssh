...
<div class="row justify-content-start">
	<div class="{if $coodivsettings.servicemarketconnect|default:''=='activated' || $coodivsettings.id|default:'' != '1'}{if $CoodivMarketConnectServices}col-md-8{/if}{/if} col-12">
	...
	{if $coodivsettings.servicemarketconnect|default:''=='activated' || $coodivsettings.id|default:'' != '1'}
