<div class="main__footer__wrapper full__footer full__with__section">
	{if $coodivfootersettings.themefootersettingstyle!='footerlayoutstylesaven'}
	<div class="bottom__footer__wrapper">
		<div class="main__page__content">
			<div class="row justify-content-start">
				{if $coodivfootersettings.themefootersettingstyle!='footerlayoutstyletwo' && $coodivfootersettings.themefootersettingstyle!='footerlayoutstylefive'}
				<div class="col-lg-4 col-12 mb-lg-0 mb-15 {if $coodivfootersettings.themefootersettingstyle=='footerlayoutstylethree' || $coodivfootersettings.themefootersettingstyle=='footerlayoutstylesix'}order-12{/if}">
							...
							<a aria-label="website homepage" class="website__identity__sidebar__link text-center d-flex align-items-center gap-10" href="{$WEB_ROOT}/index.php">
								...
								{else}
									{if $coodivsettings.defaultlogolinkfull}
										<img class="image__logo__tagline white__logo custom__website__full__logo" src="{$coodivsettings.defaultlogolinkfull}" alt="{$companyname} logo" />
										<img class="image__logo__tagline dark__logo custom__website__full__logo" src="{$coodivsettings.darklogolinkfull}" alt="{$companyname} logo" />
									{else}
					...
					{if $coodivfootersettings.themefootersettingdescription == null}
						{$LANG.shufytheme.footercompanydesciption}
					{else}
						{$coodivfootersettings.themefootersettingdescription}
					{/if}
					</p>
					<div class="d-flex flex-column gap-5 mt-7">
						{if $coodivfootersettings.themefootersettingmobile=='activated' || $coodivfootersettings.id != '1'}
						<a class="footer__contact__methods__item d-flex align-items-center gap-6 coodiv-text-12 font-weight-600" href="tel:{if $coodivfootersettings.themefootersettingcustommobile == null}00123456789011{else}{$coodivfootersettings.themefootersettingcustommobile}{/if}"><i class="fal fa-phone"></i> {if $coodivfootersettings.themefootersettingcustommobile == null}00123 456 78 90 11{else}{$coodivfootersettings.themefootersettingcustommobile}{/if}</a>
						{/if}
						{if $coodivfootersettings.themefootersettingemail=='activated' || $coodivfootersettings.id != '1'}
						<a class="footer__contact__methods__item d-flex align-items-center gap-6 coodiv-text-12 font-weight-600" href="mailto:{if $coodivfootersettings.themefootersettingcustomemail == null}support@coodiv.net{else}{$coodivfootersettings.themefootersettingcustomemail}{/if}"><i class="fal fa-envelope"></i> {if $coodivfootersettings.themefootersettingcustomemail == null}support@coodiv.net{else}{$coodivfootersettings.themefootersettingcustomemail}{/if}</a>
						{/if}
						{if $coodivfootersettings.themefootersettingadress=='activated' || $coodivfootersettings.id != '1'}
						<p class="footer__contact__methods__item d-flex align-items-center gap-6 coodiv-text-12 font-weight-500"><i class="fal fa-home"></i>{if $coodivfootersettings.themefootersettingcustomcopyrighttext == null}551 Swanston Street, Melbourne, Victoria 3053 Australia{else}{$coodivfootersettings.themefootersettingcustomcopyrighttext}{/if}</p>
						{/if}
					</div>
					</div>
				</div>
				...
				{if $shufythemefooteritems}
					{foreach $shufythemefooteritems as $element}
						<div class="{if $coodivfootersettings.accordionfootermenu=='activated' || $coodivfootersettings.id != '1'}accordion__footer__menu{/if} footer__menu__links__wrapper col-md col-4 mb-10 mb-md-0">
				...
				{else}
					...
					<div class="{if $coodivfootersettings.accordionfootermenu=='activated' || $coodivfootersettings.id != '1'}accordion__footer__menu{/if} footer__menu__links__wrapper col-md col-4 mb-md-0">
						<div class="bottom__footer__links__wrapper">
	...
	{if $coodivfootersettings.themefootersettingstyle!='footerlayoutstylefour' && $coodivfootersettings.themefootersettingstyle!='footerlayoutstylefive' && $coodivfootersettings.themefootersettingstyle!='footerlayoutstylesix'}
				...
				<div class="row justify-content-between">
					<div class="col-md col-12">
						<div class="footer__copyright__wrapper__text">
							...
							{if $coodivfootersettings.themefootersettingpoworedbycoodiv=='activated' || $coodivfootersettings.id != '1'}
					...
					{if $coodivfootersettings.themefootersettingsocialicons == 'activated' || $coodivfootersettings.id != '1'}
					<div class="col-md col-12 mt-md-0 mt-5 d-flex align-items-center  justify-content-md-end justify-content-center gap-10">
						...
						{if $coodivsettings.footerlanguagelanguage=='activated'}
