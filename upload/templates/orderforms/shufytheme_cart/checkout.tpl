<div class="checkout__informations__wrapper">
	...
	<div class="already__registered__wrapper default__shadow__panel" id="alreadyRegisteredAccordion">
	  ...
	  <div class="already__registered__card {if $loggedin}border-0{/if}">
		...
		<div id="already__registered__wrapper__login" class="collapse show" aria-labelledby="logincard" data-parent="#alreadyRegisteredAccordion">
		  <div class="already__registered__card__body {if $loggedin}pt-0 pb-0{/if}">
			  {if $loggedin}
				<div id="containerExistingAccountSelect" class="row panel__check__cart__group justify-content-start">
					{foreach $accounts as $account}
						<div class="col-md-4 col-12">
							<div class="radio__check__panel default__shadow__panel">
								<div class="default__shadow__panel__body__small px-7 py-5">
									<label class="panel__check__cart__group__label d-flex justify-content-start" for="account{$account->id}">
										...
										<div class="panel__check__cart__group__content pl-5">
											<h6 class="coodiv-text-10">
					...
					<div class="col-md-4 col-12">
						<div class="radio__check__panel default__shadow__panel">
							<div class="default__shadow__panel__body__small px-7 py-5">
								<label class="panel__check__cart__group__label d-flex justify-content-start" for="createnewaccount">
									<div class="cercle__input__radio input">
										<input id="createnewaccount" class="account-select" type="radio" name="account_id" value="new"{if !$selectedAccountId || !is_numeric($selectedAccountId)} checked="checked"{/if}{if $inExpressCheckout} disabled="disabled" class="disabled"{/if}>
										<div class="icheck__control__check__icon">
											<div class="icheck__control__check__icon__checked__effect"></div>
										</div>
									</div>
			...
			{else}
				<div class="checkout__page__auth__wrapper" id="containerExistingUserSignin">
					...
					{include file="orderforms/shufytheme_cart/linkedaccounts.tpl" linkContext="checkout-existing"}
				</div>
			{/if}
	  ...
	  <div class="already__registered__card">
		...
		<div id="already__registered__wrapper__register" {if !$loggedin}class="collapse" aria-labelledby="registercard" data-parent="#alreadyRegisteredAccordion"{/if}>
		  <div class="checkout__page__auth__wrapper already__registered__card__body {if $loggedin}p-0{/if}">
		  <div id="containerNewUserSignup" {if $custtype === 'existing' || (is_numeric($selectedAccountId) && $selectedAccountId > 0) || ( $loggedin && $selectedAccountId !== 'new' && $custtype !== 'add' ) } class="w-hidden" {/if} >
			...
			<div class="{if $loggedin}w-hidden{/if} checkout__page__register__wrapper__social">
	...
	{if $domainsinorder}
		...
		<div class="field-container mt-8">
			...
			<div class="default__shadow__panel">
				...
				{if $accepttos}
				<div class="accepttos__checkout__wrapper">
		...
		<div class="{if $captcha}{$captcha->getButtonClass($captchaForm)}{/if}"></div>			
	</form>
	{if $servedOverSsl}
