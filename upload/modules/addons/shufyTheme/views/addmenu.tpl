					...
					<div class="row">
						...
						<div class="col-lg-6 col-12">
							<div class="form-group">
								...
								<input type="text" name="css_icon" id="inputGroupIconshufytheme" class="form-control input-sm" placeholder="eg. fa-solid fa-house">
			...
			<div class="add__new__menu__form__groups__sidebar">
				...
				<div class="form-group">
					...
					<select name="parentid" id="parentid" class="form-control input-sm">
						...
						<option value="{$item.id|default:''}">{$item.title|default:''}</option>
						{foreach from=$item.sub|default:'' item=subitem}
						<option value="{$subitem.id|default:''}">&nbsp;&nbsp;-- {$subitem.title|default:''}</option>
						{/foreach}
						{/foreach}
					</select>
				</div>
