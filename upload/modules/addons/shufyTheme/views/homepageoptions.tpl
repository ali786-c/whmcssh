...
<div class="settings__popupalert__coodiv alert alert-success alert-dismissible show" role="alert">
  ...
  <div class="text">
  <strong>Success!</strong> Shufytheme Homepage settings options has been reset successfully.
  </div>
...
<div class="settings__popupalert__coodiv alert alert-success alert-dismissible show" role="alert">
  ...
  <span class="icon"><i class="fal fa-check-circle"></i></span>
  <div class="text">
  <strong>Success!</strong> Shufytheme Homepage settings options has been saved successfully.
  </div>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
	<span aria-hidden="true">&times;</span>
  </button>
...
<div class="page__wrapper__content">
	<div class="coodiv__main__hero with__menu">
		...
		<ul class="navbar-nav coodiv__main__hero__nav">
		  ...
		  <li class="nav-item active"><a class="nav-link">Homepage</a></li>
		  <li class="nav-item"><a class="nav-link" href="{$modurl}&action=listgroup">Menus</a></li> 
	...
	<form id="applyhomepageoptions" class="full__fieldset__area default__form__panel__cart coodiv__whmcs__admin__panel__form shufytheme__ajax__save" action="{$modurl}&action=applyhomepageoptions" method="post">
		<div class="section">
					...
					<fieldset>
						<div class="radio">
							<label>
								...
								<input type="radio" name="themehomepagesettingstyle" id="themehomepagestyleone" value="themehomepagestyleeone" {if $themehomepagesetting.themehomepagesettingstyle|default:''=='themehomepagestyleeone' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
						...
						<div class="radio disabled" data-toggle="tooltip" data-placement="bottom" title="New homepage layouts will added soon">
							<label>
								...
								<input type="radio" name="themehomepagesettingstyle" id="themehomepagestyletwo" value="themehomepagestyletwo" {if $themehomepagesetting.themehomepagesettingstyle|default:''=='themehomepagestyletwo'}checked{/if} disabled>
						...
						<div class="radio disabled" data-toggle="tooltip" data-placement="bottom" title="New homepage layouts will added soon">
							<label>
								<img src="../modules/addons/shufyTheme/assets/img/no-item.webp" alt="">
								<input type="radio" name="themehomepagesettingstyle" id="themehomepagestylethree" value="themehomepagestylethree" {if $themehomepagesetting.themehomepagesettingstyle|default:''=='themehomepagestylethree'}checked{/if} disabled>
						...
						<div class="radio disabled" data-toggle="tooltip" data-placement="bottom" title="New homepage layouts will added soon">
							<label>
								<img src="../modules/addons/shufyTheme/assets/img/no-item.webp" alt="">
								<input type="radio" name="themehomepagesettingstyle" id="themehomepagestylefour" value="themehomepagestylefour" {if $themehomepagesetting.themehomepagesettingstyle|default:''=='themehomepagestylefour'}checked{/if} disabled>
			...
			<div class="form-group-wrapper-shadow">
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themehomepagesettinghomepagefeaturedsection" id="themehomepagesettinghomepagefeaturedsection">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themehomepagesettinghomepagefeaturedsection" id="themehomepagesettinghomepagefeaturedsection" value="activated" {if $themehomepagesetting.themehomepagesettinghomepagefeaturedsection|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group">
					...
					<input type="text" name="themehomepagesettinghomepagefeaturedsectiontitle" id="themehomepagesettinghomepagefeaturedsectiontitle" {if $themehomepagesetting.themehomepagesettinghomepagefeaturedsectiontitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettinghomepagefeaturedsectiontitle|default:''}"{/if} class="form-control" >
				</div>
				<div class="form-group">
					<label for="themehomepagesettinghomepagefeaturedsectionsubtitle">Homepage features services section sub title</label>
					<input type="text" name="themehomepagesettinghomepagefeaturedsectionsubtitle" id="themehomepagesettinghomepagefeaturedsectionsubtitle" {if $themehomepagesetting.themehomepagesettinghomepagefeaturedsectionsubtitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettinghomepagefeaturedsectionsubtitle|default:''}"{/if} class="form-control" >
				</div>
				<div class="form-group templates__form__control">
					...
					<fieldset name="themehomepagesettingfeaturedfirst" id="themehomepagesettingfeaturedfirst">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themehomepagesettingfeaturedfirst" id="themehomepagesettingfeaturedfirst" value="activated" {if $themehomepagesetting.themehomepagesettingfeaturedfirst|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themehomepagesettingfeaturedssecond" id="themehomepagesettingfeaturedssecond">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themehomepagesettingfeaturedssecond" id="themehomepagesettingfeaturedssecond" value="activated" {if $themehomepagesetting.themehomepagesettingfeaturedssecond|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themehomepagesettingfeaturedthird" id="themehomepagesettingfeaturedthird">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themehomepagesettingfeaturedthird" id="themehomepagesettingfeaturedthird" value="activated" {if $themehomepagesetting.themehomepagesettingfeaturedthird|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturedfirstcontenttitle" id="themehomepagesettingfeaturedfirstcontenttitle" {if $themehomepagesetting.themehomepagesettingfeaturedfirstcontenttitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedfirstcontenttitle|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturedfirstcontenttitleicon" id="themehomepagesettingfeaturedfirstcontenttitleicon" {if $themehomepagesetting.themehomepagesettingfeaturedfirstcontenttitleicon|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedfirstcontenttitleicon|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturedfirstcontentsubtitletwo" id="themehomepagesettingfeaturedfirstcontentsubtitletwo" {if $themehomepagesetting.themehomepagesettingfeaturedfirstcontentsubtitletwo|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedfirstcontentsubtitletwo|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturedsecondcontentprice" id="themehomepagesettingfeaturedsecondcontentprice" {if $themehomepagesetting.themehomepagesettingfeaturedsecondcontentprice|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedsecondcontentprice|default:''}"{/if} class="form-control" >
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturedfirstcontentprice" id="themehomepagesettingfeaturedfirstcontentprice" {if $themehomepagesetting.themehomepagesettingfeaturedfirstcontentprice|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedfirstcontentprice|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea class="form-control" id="themehomepagesettingfeaturedfirstcontentdescription" name="themehomepagesettingfeaturedfirstcontentdescription" rows="6" cols="50" placeholder="Use this filed to add your custom css code to shufy theme">{if $themehomepagesetting.themehomepagesettingfeaturedfirstcontentdescription|default:'' == null}{else}{$themehomepagesetting.themehomepagesettingfeaturedfirstcontentdescription|default:''}{/if}</textarea>
						</div>
						<div class="form-group">
							...
							<input type="url" name="themehomepagesettingfeaturedfirstcontentinllustration" id="themehomepagesettingfeaturedfirstcontentinllustration" {if $themehomepagesetting.themehomepagesettingfeaturedfirstcontentinllustration|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedfirstcontentinllustration|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturedfirstcontentbutton" id="themehomepagesettingfeaturedfirstcontentbutton" {if $themehomepagesetting.themehomepagesettingfeaturedfirstcontentbutton|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedfirstcontentbutton|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="url" name="themehomepagesettingfeaturedfirstcontentbuttonlink" id="themehomepagesettingfeaturedfirstcontentbuttonlink" {if $themehomepagesetting.themehomepagesettingfeaturedfirstcontentbuttonlink|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedfirstcontentbuttonlink|default:''}"{/if} class="form-control" >
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeatureddomomainsectiontitle" id="themehomepagesettingfeatureddomomainsectiontitle" {if $themehomepagesetting.themehomepagesettingfeatureddomomainsectiontitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeatureddomomainsectiontitle|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeatureddomomainsectionsubtitle" id="themehomepagesettingfeatureddomomainsectionsubtitle" {if $themehomepagesetting.themehomepagesettingfeatureddomomainsectionsubtitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeatureddomomainsectionsubtitle|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeatureddomomainsectionsubtitletwo" id="themehomepagesettingfeatureddomomainsectionsubtitletwo" {if $themehomepagesetting.themehomepagesettingfeatureddomomainsectionsubtitletwo|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeatureddomomainsectionsubtitletwo|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeatureddomomainsectionsubtitlethree" id="themehomepagesettingfeatureddomomainsectionsubtitlethree" {if $themehomepagesetting.themehomepagesettingfeatureddomomainsectionsubtitlethree|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeatureddomomainsectionsubtitlethree|default:''}"{/if} class="form-control" >
						</div>
					</div>
					...
					<div class="col-md-6">	
						...
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturedsecondcontenttitle" id="themehomepagesettingfeaturedsecondcontenttitle" {if $themehomepagesetting.themehomepagesettingfeaturedsecondcontenttitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedsecondcontenttitle|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="url" name="themehomepagesettingfeaturedsecondcontenttitleicon" id="themehomepagesettingfeaturedsecondcontenttitleicon" {if $themehomepagesetting.themehomepagesettingfeaturedsecondcontenttitleicon|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedsecondcontenttitleicon|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturedsecondcontentsubtitleone" id="themehomepagesettingfeaturedsecondcontentsubtitleone" {if $themehomepagesetting.themehomepagesettingfeaturedsecondcontentsubtitleone|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedsecondcontentsubtitleone|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="url" name="themehomepagesettingfeaturedsecondcontentsubtitleoneicon" id="themehomepagesettingfeaturedsecondcontentsubtitleoneicon" {if $themehomepagesetting.themehomepagesettingfeaturedsecondcontentsubtitleoneicon|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedsecondcontentsubtitleoneicon|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturedsecondcontentsubtitletwo" id="themehomepagesettingfeaturedsecondcontentsubtitletwo" {if $themehomepagesetting.themehomepagesettingfeaturedsecondcontentsubtitletwo|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedsecondcontentsubtitletwo|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="url" name="themehomepagesettingfeaturedsecondcontentsubtitletwoicon" id="themehomepagesettingfeaturedsecondcontentsubtitletwoicon" {if $themehomepagesetting.themehomepagesettingfeaturedsecondcontentsubtitletwoicon|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedsecondcontentsubtitletwoicon|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturedsecondcontentsubtitlethree" id="themehomepagesettingfeaturedsecondcontentsubtitlethree" {if $themehomepagesetting.themehomepagesettingfeaturedsecondcontentsubtitlethree|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedsecondcontentsubtitlethree|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturedsecondcontentinllustration" id="themehomepagesettingfeaturedsecondcontentinllustration" {if $themehomepagesetting.themehomepagesettingfeaturedsecondcontentinllustration|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedsecondcontentinllustration|default:''}"{/if} class="form-control" >
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturedsecondcontentpricebilling" id="themehomepagesettingfeaturedsecondcontentpricebilling" {if $themehomepagesetting.themehomepagesettingfeaturedsecondcontentpricebilling|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedsecondcontentpricebilling|default:''}"{/if} class="form-control" >
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturedsecondcontentbutton" id="themehomepagesettingfeaturedsecondcontentbutton" {if $themehomepagesetting.themehomepagesettingfeaturedsecondcontentbutton|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedsecondcontentbutton|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="url" name="themehomepagesettingfeaturedsecondcontentbuttonlink" id="themehomepagesettingfeaturedsecondcontentbuttonlink" {if $themehomepagesetting.themehomepagesettingfeaturedsecondcontentbuttonlink|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturedsecondcontentbuttonlink|default:''}"{/if} class="form-control" >
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-md-4 col-12">
						...
						<div class="form-group templates__form__control">
							...
							<fieldset name="themehomepagesettingfeaturescolorsplansfirst">
								<div class="radio">
								<label class="template__label">
									<input type="checkbox" name="themehomepagesettingfeaturescolorsplansfirst" id="themehomepagesettingfeaturescolorsplansfirst" value="activated" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirst|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
									Display Homepage second featured plan
									<span class="checkmark"><i class="fal fa-check"></i></span>
								</label>
								</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplansfirstbg" name="themehomepagesettingfeaturescolorsplansfirstbg" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbg|default:'' == null}value="#eaf9fd"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbg|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplansfirstbgdark" name="themehomepagesettingfeaturescolorsplansfirstbgdark" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbgdark|default:'' == null}value="#000"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbgdark|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplansfirstbtnhover" name="themehomepagesettingfeaturescolorsplansfirstbtnhover" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbtnhover|default:'' == null}value="#14a6e7"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbtnhover|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplansfirstbtncolordark" name="themehomepagesettingfeaturescolorsplansfirstbtncolordark" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbtncolordark|default:'' == null}value="#333"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbtncolordark|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplansfirstbtnbgdarkhover" name="themehomepagesettingfeaturescolorsplansfirstbtnbgdarkhover" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbtnbgdarkhover|default:'' == null}value="#333"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbtnbgdarkhover|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturescolorsplansfirsticon" id="themehomepagesettingfeaturescolorsplansfirsticon" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirsticon|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansfirsticon|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturescolorsplansfirsttitle" id="themehomepagesettingfeaturescolorsplansfirsttitle" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirsttitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansfirsttitle|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturescolorsplansfirstsubtitle" id="themehomepagesettingfeaturescolorsplansfirstsubtitle" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstsubtitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstsubtitle|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<textarea class="form-control" id="themehomepagesettingfeaturescolorsplansfirstdescription" name="themehomepagesettingfeaturescolorsplansfirstdescription" rows="6" cols="50" placeholder="Use this filed to add your custom css code to shufy theme">{if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstdescription|default:'' == null}{else}{$themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstdescription|default:''}{/if}</textarea>
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturescolorsplansfirstprice" id="themehomepagesettingfeaturescolorsplansfirstprice" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstprice|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstprice|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturescolorsplansfirstbilling" id="themehomepagesettingfeaturescolorsplansfirstbilling" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbilling|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbilling|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturescolorsplansfirstbtntext" id="themehomepagesettingfeaturescolorsplansfirstbtntext" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbtntext|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbtntext|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="url" name="themehomepagesettingfeaturescolorsplansfirstbtnlink" id="themehomepagesettingfeaturescolorsplansfirstbtnlink" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbtnlink|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansfirstbtnlink|default:''}"{/if} class="form-control" >
						</div>
						</div>
					</div>
					...
					<div class="col-md-4 col-12">
						<div class="form-group templates__form__control">
							...
							<fieldset name="themehomepagesettingfeaturescolorsplanssecond" id="themehomepagesettingfeaturescolorsplanssecond">
								<div class="radio">
								<label class="template__label">
									<input type="checkbox" name="themehomepagesettingfeaturescolorsplanssecond" id="themehomepagesettingfeaturescolorsplanssecond" value="activated" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplanssecond|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
									Display Homepage second featured plan
									<span class="checkmark"><i class="fal fa-check"></i></span>
								</label>
								</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplanssecondbg" name="themehomepagesettingfeaturescolorsplanssecondbg" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbg|default:'' == null}value="#e9fde9"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbg|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplanssecondbgdark" name="themehomepagesettingfeaturescolorsplanssecondbgdark" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbgdark|default:'' == null}value="#333"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbgdark|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplanssecondbtnbg" name="themehomepagesettingfeaturescolorsplanssecondbtnbg" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbtnbg|default:'' == null}value="#6be577"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbtnbg|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplanssecondbtncolor" name="themehomepagesettingfeaturescolorsplanssecondbtncolor" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbtncolor|default:'' == null}value="#fff"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbtncolor|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplanssecondbtncolordark" name="themehomepagesettingfeaturescolorsplanssecondbtncolordark" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbtncolordark|default:'' == null}value="#333"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbtncolordark|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplanssecondbtnbgdarkhover" name="themehomepagesettingfeaturescolorsplanssecondbtnbgdarkhover" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbtnbgdarkhover|default:'' == null}value="#333"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbtnbgdarkhover|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturescolorsplanssecondicon" id="themehomepagesettingfeaturescolorsplanssecondicon" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondicon|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondicon|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea class="form-control" id="themehomepagesettingfeaturescolorsplansseconddescription" name="themehomepagesettingfeaturescolorsplansseconddescription" rows="6" cols="50" placeholder="Use this filed to add your custom css code to shufy theme">{if $themehomepagesetting.themehomepagesettingfeaturescolorsplansseconddescription|default:'' == null}{else}{$themehomepagesetting.themehomepagesettingfeaturescolorsplansseconddescription|default:''}{/if}</textarea>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturescolorsplanssecondbtntext" id="themehomepagesettingfeaturescolorsplanssecondbtntext" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbtntext|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbtntext|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="url" name="themehomepagesettingfeaturescolorsplanssecondbtnlink" id="themehomepagesettingfeaturescolorsplanssecondbtnlink" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbtnlink|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplanssecondbtnlink|default:''}"{/if} class="form-control" >
						</div>
						</div>
					</div>
					...
					<div class="col-md-4 col-12">
						<div class="form-group templates__form__control">
							...
							<fieldset name="themehomepagesettingfeaturescolorsplansthird" id="themehomepagesettingfeaturescolorsplansthird">
								<div class="radio">
								<label class="template__label">
									<input type="checkbox" name="themehomepagesettingfeaturescolorsplansthird" id="themehomepagesettingfeaturescolorsplansthird" value="activated" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansthird|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplansthirdbg" name="themehomepagesettingfeaturescolorsplansthirdbg" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbg|default:'' == null}value="#f7f0fd"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbg|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplansthirdbgdark" name="themehomepagesettingfeaturescolorsplansthirdbgdark" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbgdark|default:'' == null}value="#333"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbgdark|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplansthirdbtnbg" name="themehomepagesettingfeaturescolorsplansthirdbtnbg" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbtnbg|default:'' == null}value="#9986f4"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbtnbg|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplansthirdbtncolor" name="themehomepagesettingfeaturescolorsplansthirdbtncolor" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbtncolor|default:'' == null}value="#fff"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbtncolor|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplansthirdbtnbgdark" name="themehomepagesettingfeaturescolorsplansthirdbtnbgdark" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbtnbgdark|default:'' == null}value="#333"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbtnbgdark|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplansthirdbtncolordark" name="themehomepagesettingfeaturescolorsplansthirdbtncolordark" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbtncolordark|default:'' == null}value="#333"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbtncolordark|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input class="form-control color-picker" id="themehomepagesettingfeaturescolorsplansthirdbtnbgdarkhover" name="themehomepagesettingfeaturescolorsplansthirdbtnbgdarkhover" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbtnbgdarkhover|default:'' == null}value="#333"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbtnbgdarkhover|default:''}"{/if} data-jscolor="{
								  preset: 'dark',
								  closeButton: true,
								  closeText: 'OK'}">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturescolorsplansthirdicon" id="themehomepagesettingfeaturescolorsplansthirdicon" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdicon|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdicon|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
							...
							<input type="text" name="themehomepagesettingfeaturescolorsplansthirdtitle" id="themehomepagesettingfeaturescolorsplansthirdtitle" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdtitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdtitle|default:''}"{/if} class="form-control" >
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<textarea class="form-control" id="themehomepagesettingfeaturescolorsplansthirddescription" name="themehomepagesettingfeaturescolorsplansthirddescription" rows="6" cols="50" placeholder="Use this filed to add your custom css code to shufy theme">{if $themehomepagesetting.themehomepagesettingfeaturescolorsplansthirddescription|default:'' == null}{else}{$themehomepagesetting.themehomepagesettingfeaturescolorsplansthirddescription|default:''}{/if}</textarea>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="url" name="themehomepagesettingfeaturescolorsplansthirdbtnlink" id="themehomepagesettingfeaturescolorsplansthirdbtnlink" {if $themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbtnlink|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingfeaturescolorsplansthirdbtnlink|default:''}"{/if} class="form-control" >
						</div>
						</div>
					</div>
			...
			<div class="form-group-wrapper-shadow">
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themehomepagesettingservicesfeatures" id="themehomepagesettingservicesfeatures">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themehomepagesettingservicesfeatures" id="themehomepagesettingservicesfeatures" value="activated" {if $themehomepagesetting.themehomepagesettingservicesfeatures|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="homepage__features__boxes__collpassing">
					<div class="form-group">
						...
						<input type="text" name="themehomepagesettingservicesfeaturestagline" id="themehomepagesettingservicesfeaturestagline" {if $themehomepagesetting.themehomepagesettingservicesfeaturestagline|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingservicesfeaturestagline|default:''}"{/if} class="form-control" >
					</div>
					<div class="form-group">
						...
						<input type="text" name="themehomepagesettingservicesfeaturestitle" id="themehomepagesettingservicesfeaturestitle" {if $themehomepagesetting.themehomepagesettingservicesfeaturestitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingservicesfeaturestitle|default:''}"{/if} class="form-control" >
					</div>
					<div class="form-group">
						...
						<input type="text" name="themehomepagesettingservicesfeaturessubtitle" id="themehomepagesettingservicesfeaturessubtitle" {if $themehomepagesetting.themehomepagesettingservicesfeaturessubtitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingservicesfeaturessubtitle|default:''}"{/if} class="form-control" >
					</div>
						...
						<div class="col-md-3 col-12">
							<div class="form-group templates__form__control">
								...
								<fieldset name="themehomepagesettingservicesfeaturessecond" id="themehomepagesettingservicesfeaturessecond">
									<div class="radio">
									<label class="template__label">
										<input type="checkbox" name="themehomepagesettingservicesfeaturessecond" id="themehomepagesettingservicesfeaturessecond" value="activated" {if $themehomepagesetting.themehomepagesettingservicesfeaturessecond|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
							...
							<div class="form-group">
								...
								<input type="url" name="themehomepagesettingservicesfeaturessecondicon" id="themehomepagesettingservicesfeaturessecondicon" {if $themehomepagesetting.themehomepagesettingservicesfeaturessecondicon|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingservicesfeaturessecondicon|default:''}"{/if} class="form-control" >
							</div>
							<div class="form-group">
								...
								<input type="text" name="themehomepagesettingservicesfeaturessecondtitle" id="themehomepagesettingservicesfeaturessecondtitle" {if $themehomepagesetting.themehomepagesettingservicesfeaturessecondtitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingservicesfeaturessecondtitle|default:''}"{/if} class="form-control" >
							</div>
							<div class="form-group">
								...
								<input type="text" name="themehomepagesettingservicesfeaturesseconddescription" id="themehomepagesettingservicesfeaturesseconddescription" {if $themehomepagesetting.themehomepagesettingservicesfeaturesseconddescription|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingservicesfeaturesseconddescription|default:''}"{/if} class="form-control" >
							</div>
						</div>
						...
						<div class="col-md-3 col-12">
							<div class="form-group templates__form__control">
								...
								<fieldset name="themehomepagesettingservicesfeaturesthird" id="themehomepagesettingservicesfeaturesthird">
									<div class="radio">
									<label class="template__label">
										<input type="checkbox" name="themehomepagesettingservicesfeaturesthird" id="themehomepagesettingservicesfeaturesthird" value="activated" {if $themehomepagesetting.themehomepagesettingservicesfeaturesthird|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
							...
							<div class="form-group">
								...
								<input type="url" name="themehomepagesettingservicesfeaturesthirdicon" id="themehomepagesettingservicesfeaturesthirdicon" {if $themehomepagesetting.themehomepagesettingservicesfeaturesthirdicon|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingservicesfeaturesthirdicon|default:''}"{/if} class="form-control" >
							</div>
							<div class="form-group">
								...
								<input type="text" name="themehomepagesettingservicesfeaturesthirdtitle" id="themehomepagesettingservicesfeaturesthirdtitle" {if $themehomepagesetting.themehomepagesettingservicesfeaturesthirdtitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingservicesfeaturesthirdtitle|default:''}"{/if} class="form-control" >
							</div>
							<div class="form-group">
						...
						<div class="col-md-3 col-12">
							<div class="form-group templates__form__control">
								...
								<fieldset name="themehomepagesettingservicesfeaturesfourth" id="themehomepagesettingservicesfeaturesfourth">
									<div class="radio">
									<label class="template__label">
										<input type="checkbox" name="themehomepagesettingservicesfeaturesfourth" id="themehomepagesettingservicesfeaturesfourth" value="activated" {if $themehomepagesetting.themehomepagesettingservicesfeaturesfourth|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
							...
							<div class="form-group">
								...
								<input type="url" name="themehomepagesettingservicesfeaturesfourthicon" id="themehomepagesettingservicesfeaturesfourthicon" {if $themehomepagesetting.themehomepagesettingservicesfeaturesfourthicon|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingservicesfeaturesfourthicon|default:''}"{/if} class="form-control" >
							</div>
							<div class="form-group">
								...
								<input type="text" name="themehomepagesettingservicesfeaturesfourthtitle" id="themehomepagesettingservicesfeaturesfourthtitle" {if $themehomepagesetting.themehomepagesettingservicesfeaturesfourthtitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingservicesfeaturesfourthtitle|default:''}"{/if} class="form-control" >
							</div>
							<div class="form-group">
						...
						<div class="col-md-3 col-12">
							<div class="form-group templates__form__control">
								...
								<fieldset name="themehomepagesettingservicesfeaturesfivth" id="themehomepagesettingservicesfeaturesfivth">
									<div class="radio">
									<label class="template__label">
										<input type="checkbox" name="themehomepagesettingservicesfeaturesfivth" id="themehomepagesettingservicesfeaturesfivth" value="activated" {if $themehomepagesetting.themehomepagesettingservicesfeaturesfivth|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
							...
							<div class="form-group">
								...
								<input type="url" name="themehomepagesettingservicesfeaturesfivthicon" id="themehomepagesettingservicesfeaturesfivthicon" {if $themehomepagesetting.themehomepagesettingservicesfeaturesfivthicon|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingservicesfeaturesfivthicon|default:''}"{/if} class="form-control" >
							</div>
							<div class="form-group">
								...
								<input type="text" name="themehomepagesettingservicesfeaturesfivthtitle" id="themehomepagesettingservicesfeaturesfivthtitle" {if $themehomepagesetting.themehomepagesettingservicesfeaturesfivthtitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingservicesfeaturesfivthtitle|default:''}"{/if} class="form-control" >
							</div>
							<div class="form-group">
								...
								<input type="text" name="themehomepagesettingservicesfeaturesfivthdescription" id="themehomepagesettingservicesfeaturesfivthdescription" {if $themehomepagesetting.themehomepagesettingservicesfeaturesfivthdescription|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingservicesfeaturesfivthdescription|default:''}"{/if} class="form-control" >
							</div>
						</div>
			...
			<div class="col-md-6 col-12">
				<div class="form-group templates__form__control">
					...
					<fieldset name="themehomepagesettingsavingbanner" id="themehomepagesettingsavingbanner">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themehomepagesettingsavingbanner" id="themehomepagesettingsavingbanner" value="activated" {if $themehomepagesetting.themehomepagesettingsavingbanner|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group">
					...
					<input type="text" name="themehomepagesettingsavingbannertitle" id="themehomepagesettingsavingbannertitle" {if $themehomepagesetting.themehomepagesettingsavingbannertitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingsavingbannertitle|default:''}"{/if} class="form-control" >
				</div>
				<div class="form-group">
					...
					<input type="text" name="themehomepagesettingsavingbannersubtitle" id="themehomepagesettingsavingbannersubtitle" {if $themehomepagesetting.themehomepagesettingsavingbannersubtitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingsavingbannersubtitle|default:''}"{/if} class="form-control" >
				</div>
				<div class="form-group">
					...
					<input type="text" name="themehomepagesettingsavingbannerbtntext" id="themehomepagesettingsavingbannerbtntext" {if $themehomepagesetting.themehomepagesettingsavingbannerbtntext|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingsavingbannerbtntext|default:''}"{/if} class="form-control" >
				</div>
				<div class="form-group">
					...
					<input type="url" name="themehomepagesettingsavingbannerbtnlink" id="themehomepagesettingsavingbannerbtnlink" {if $themehomepagesetting.themehomepagesettingsavingbannerbtnlink|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingsavingbannerbtnlink|default:''}"{/if} class="form-control" >
				</div>
			</div>
			...
			<div class="col-md-6 col-12">
				<div class="form-group templates__form__control">
					...
					<fieldset name="themehomepagesettingsubscribingsection" id="themehomepagesettingsubscribingsection">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themehomepagesettingsubscribingsection" id="themehomepagesettingsubscribingsection" value="activated" {if $themehomepagesetting.themehomepagesettingsubscribingsection|default:''=='activated' || $themehomepagesetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group">
					...
					<input type="text" name="themehomepagesettingsubscribingsectiontitle" id="themehomepagesettingsubscribingsectiontitle" {if $themehomepagesetting.themehomepagesettingsubscribingsectiontitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingsubscribingsectiontitle|default:''}"{/if} class="form-control" >
				</div>
				<div class="form-group">
					...
					<input type="text" name="themehomepagesettingsubscribingsectionsubtitle" id="themehomepagesettingsubscribingsectionsubtitle" {if $themehomepagesetting.themehomepagesettingsubscribingsectionsubtitle|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingsubscribingsectionsubtitle|default:''}"{/if} class="form-control" >
				</div>
				<div class="form-group">
					...
					<input type="text" name="themehomepagesettingsubscribingsectionmailchimpusername" id="themehomepagesettingsubscribingsectionmailchimpusername" {if $themehomepagesetting.themehomepagesettingsubscribingsectionmailchimpusername|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themehomepagesetting.themehomepagesettingsubscribingsectionmailchimpusername|default:''}"{/if} class="form-control" >
				</div>
				<div class="form-group">
					...
					<input type="text" name="themehomepagesettingsubscribingsectionmailchimapi" id="themehomepagesettingsubscribingsectionmailchimapi" {if $themehomepagesetting.themehomepagesettingsubscribingsectionmailchimapi|default:'' == null}value="" placeholder="Entree Mailchimp API key"{else}value="{$themehomepagesetting.themehomepagesettingsubscribingsectionmailchimapi|default:''}"{/if} class="form-control" >
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="text" name="themehomepagesettingsubscribingsectionmailchimoption" id="themehomepagesettingsubscribingsectionmailchimoption" {if $themehomepagesetting.themehomepagesettingsubscribingsectionmailchimoption|default:'' == null}value="" placeholder="for example: us11"{else}value="{$themehomepagesetting.themehomepagesettingsubscribingsectionmailchimoption|default:''}"{/if} class="form-control" >
				</div>
			</div>
