...
<div class="settings__popupalert__coodiv alert alert-success alert-dismissible show" role="alert">
  ...
  <div class="text">
  <strong>Success!</strong> Shufytheme Footer settings options has been reset successfully.
  </div>
...
<div class="settings__popupalert__coodiv alert alert-success alert-dismissible show" role="alert">
  ...
  <span class="icon"><i class="fal fa-check-circle"></i></span>
  <div class="text">
  <strong>Success!</strong> Shufytheme Footer settings options has been saved successfully.
  </div>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
	<span aria-hidden="true">&times;</span>
  </button>
...
<div class="page__wrapper__content">
	<div class="coodiv__main__hero with__menu">
		...
		<ul class="navbar-nav coodiv__main__hero__nav">
		  ...
		  <li class="nav-item active"><a class="nav-link">Footer</a></li>
	...
	<form id="applyfooteroptions" class="full__fieldset__area default__form__panel__cart coodiv__whmcs__admin__panel__form shufytheme__ajax__save" action="{$modurl}&action=applyfooteroptions" method="post">
		<div class="section">
			...
			<div class="form-group-wrapper-shadow">
					...
					<fieldset>
						<div class="radio">
							<label>
								...
								<input type="radio" name="themefootersettingstyle" id="footerlayoutstyleone" value="footerlayoutstyleone" {if $themefootersetting.themefootersettingstyle|default:''=='footerlayoutstyleone' || $themefootersetting.id|default:'' != '1'}checked{/if}>
						...
						<div class="radio">
							<label>
								...
								<input type="radio" name="themefootersettingstyle" id="footerlayoutstyletwo" value="footerlayoutstyletwo" {if $themefootersetting.themefootersettingstyle|default:''=='footerlayoutstyletwo'}checked{/if}>
						...
						<div class="radio" data-toggle="tooltip">
							<label>
								...
								<input type="radio" name="themefootersettingstyle" id="footerlayoutstylethree" value="footerlayoutstylethree" {if $themefootersetting.themefootersettingstyle|default:''=='footerlayoutstylethree'}checked{/if}>
						...
						<div class="radio" data-toggle="tooltip">
							<label>
								...
								<input type="radio" name="themefootersettingstyle" id="footerlayoutstylefour" value="footerlayoutstylefour" {if $themefootersetting.themefootersettingstyle|default:''=='footerlayoutstylefour'}checked{/if}>
						...
						<div class="radio" data-toggle="tooltip">
							<label>
								...
								<input type="radio" name="themefootersettingstyle" id="footerlayoutstylefive" value="footerlayoutstylefive" {if $themefootersetting.themefootersettingstyle|default:''=='footerlayoutstylefive'}checked{/if}>
						...
						<div class="radio" data-toggle="tooltip">
							<label>
								...
								<input type="radio" name="themefootersettingstyle" id="footerlayoutstylesix" value="footerlayoutstylesix" {if $themefootersetting.themefootersettingstyle|default:''=='footerlayoutstylesix'}checked{/if}>
						...
						<div class="radio" data-toggle="tooltip">
							<label>
								...
								<input type="radio" name="themefootersettingstyle" id="footerlayoutstylesaven" value="footerlayoutstylesaven" {if $themefootersetting.themefootersettingstyle|default:''=='footerlayoutstylesaven'}checked{/if}>
				...
				<h6 class="sub-title">Footer settings</h6>
					<div class="form-group templates__form__control">
						<label for="accordionfootermenu">Enable the accordion Footer menu for mobile view <i data-toggle="tooltip" data-placement="bottom" title="tick/enable this field to the accordion Footer menu for mobile view" class="fas fa-info-circle"></i></label>
						<fieldset name="accordionfootermenu" id="accordionfootermenu-fieldset">
							<div class="radio">
							<label class="template__label">
								<input type="checkbox" name="accordionfootermenu" id="accordionfootermenu" value="activated" {if $themefootersetting.accordionfootermenu|default:''=='activated' || $themefootersetting.id|default:'' != '1'}checked{/if}>
								Yes, i want to enable the accordion Footer menu for mobile view
					...
					<div class="form-group templates__form__control">
						...
						<fieldset name="themefootersettinglogo" id="themefootersettinglogo">
							<div class="radio">
							<label class="template__label">
								<input type="checkbox" name="themefootersettinglogo" id="themefootersettinglogo" value="activated" {if $themefootersetting.themefootersettinglogo|default:''=='activated' || $themefootersetting.id|default:'' != '1'}checked{/if}>
					...
					<div class="form-group">
						...
						<textarea class="form-control" id="themefootersettingdescription" name="themefootersettingdescription" rows="6" cols="50" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings">{if $themefootersetting.themefootersettingdescription|default:'' == null}{else}{$themefootersetting.themefootersettingdescription|default:''}{/if}</textarea>
					</div>
					<div class="form-group templates__form__control">
						...
						<fieldset name="themefootersettingsocialicons" id="themefootersettingsocialicons">
							<div class="radio">
							<label class="template__label">
								<input type="checkbox" name="themefootersettingsocialicons" id="themefootersettingsocialicons" value="activated" {if $themefootersetting.themefootersettingsocialicons|default:''=='activated' || $themefootersetting.id|default:'' != '1'}checked{/if}>
					...
					<div class="form-group templates__form__control">
						...
						<fieldset name="themefootersettingadress" id="themefootersettingadress">
							<div class="radio">
							<label class="template__label">
								<input type="checkbox" name="themefootersettingadress" id="themefootersettingadress" value="activated" {if $themefootersetting.themefootersettingadress|default:''=='activated' || $themefootersetting.id|default:'' != '1'}checked{/if}>
					...
					<div class="form-group templates__form__control">
						...
						<fieldset name="themefootersettingmobile" id="themefootersettingmobile">
							<div class="radio">
							<label class="template__label">
								<input type="checkbox" name="themefootersettingmobile" id="themefootersettingmobile" value="activated" {if $themefootersetting.themefootersettingmobile|default:''=='activated' || $themefootersetting.id|default:'' != '1'}checked{/if}>
					...
					<div class="form-group templates__form__control">
						...
						<fieldset name="themefootersettingemail" id="themefootersettingemail">
							<div class="radio">
							<label class="template__label">
								<input type="checkbox" name="themefootersettingemail" id="themefootersettingemail" value="activated" {if $themefootersetting.themefootersettingemail|default:''=='activated' || $themefootersetting.id|default:'' != '1'}checked{/if}>
								Display the email
								<span class="checkmark"><i class="fal fa-check"></i></span>
							</label>
							</div>
					...
					<div class="form-group">
						...
						<input type="text" name="themefootersettingcustommobile" id="themefootersettingcustommobile" {if $themefootersetting.themefootersettingcustommobile|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themefootersetting.themefootersettingcustommobile|default:''}"{/if} class="form-control" >
					</div>
					<div class="form-group">
						<label for="themefootersettingcustomemail">Custom Footer support email</label>
						<input type="email" name="themefootersettingcustomemail" id="themefootersettingcustomemail" {if $themefootersetting.themefootersettingcustomemail|default:'' == null}value="" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings"{else}value="{$themefootersetting.themefootersettingcustomemail|default:''}"{/if} class="form-control" >
					</div>
					<div class="form-group">
						<label for="themefootersettingcustomcopyrighttext">Your company adress <b>HTML is NOT allowed</b> </label>
						<textarea class="form-control" id="themefootersettingcustomcopyrighttext" name="themefootersettingcustomcopyrighttext" rows="6" cols="50" placeholder="Leave this filed empty if you'd like to use the default Coodiv Shufy theme settings">{if $themefootersetting.themefootersettingcustomcopyrighttext|default:'' == null}{else}{$themefootersetting.themefootersettingcustomcopyrighttext|default:''}{/if}</textarea>
					</div>
			</div>
		</div>
	</form>
