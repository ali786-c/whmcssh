...
<div class="settings__popupalert__coodiv alert alert-success alert-dismissible show" role="alert">
  ...
  <div class="text">
  <strong>Success!</strong> Shufytheme Layouts settings options has been reset successfully.
  </div>
...
<div class="settings__popupalert__coodiv alert alert-success alert-dismissible show" role="alert">
  ...
  <span class="icon"><i class="fal fa-check-circle"></i></span>
  <div class="text">
  <strong>Success!</strong> Shufytheme Layouts settings options has been saved successfully.
  </div>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
	<span aria-hidden="true">&times;</span>
  </button>
...
<div class="page__wrapper__content">
	<div class="coodiv__main__hero with__menu">
		...
		<ul class="navbar-nav coodiv__main__hero__nav">
		  ...
		  <li class="nav-item active"><a class="nav-link">Layouts</a></li>
	...
	<form id="applylayoutoptions" class="full__fieldset__area default__form__panel__cart coodiv__whmcs__admin__panel__form shufytheme__ajax__save" action="{$modurl}&action=applylayoutoptions" method="post">
		<div class="section">
					...
					<fieldset>
						<div class="radio">
							<label>
								...
								<input type="radio" name="layoutsettingssidebarlayout" id="sidebarlayoutstyleone" value="sidebarlayoutstyleone" {if $themelayoutsetting.layoutsettingssidebarlayout|default:''=='sidebarlayoutstyleone' || $themelayoutsetting.id|default:'' != '1'}checked{/if}>
						...
						<div class="radio">
							<label>
								...
								<input type="radio" name="layoutsettingssidebarlayout" id="sidebarlayoutstyletwo" value="sidebarlayoutstyletwo" {if $themelayoutsetting.layoutsettingssidebarlayout|default:''=='sidebarlayoutstyletwo'}checked{/if}>
						...
						<div class="radio">
							<label>
								...
								<input type="radio" name="layoutsettingssidebarlayout" id="sidebarlayoutstylethree" value="sidebarlayoutstylethree" {if $themelayoutsetting.layoutsettingssidebarlayout|default:''=='sidebarlayoutstylethree'}checked{/if}>
						...
						<div class="radio">
							<label>
								...
								<input type="radio" name="layoutsettingssidebarlayout" id="sidebarlayoutstylefour" value="sidebarlayoutstylefour" {if $themelayoutsetting.layoutsettingssidebarlayout|default:''=='sidebarlayoutstylefour'}checked{/if}>
					...
					<fieldset>
						<div class="radio">
							<label>
								...
								<input type="radio" name="layoutsettingssidebarposition" id="sidebarpositionleft" value="sidebarpositionleft" {if $themelayoutsetting.layoutsettingssidebarposition|default:''=='sidebarpositionleft' || $themelayoutsetting.id|default:'' != '1'}checked{/if}>
						...
						<div class="radio">
							<label>
								...
								<input type="radio" name="layoutsettingssidebarposition" id="sidebarpositionright" value="sidebarpositionright" {if $themelayoutsetting.layoutsettingssidebarposition|default:''=='sidebarpositionright'}checked{/if}>
						...
						<div class="radio">
							<label>
								...
								<input type="radio" name="layoutsettingssidebarposition" id="sidebarpositiontop" value="sidebarpositiontop" {if $themelayoutsetting.layoutsettingssidebarposition|default:''=='sidebarpositiontop'}checked{/if}>
						...
						<div class="radio">
							<label>
								...
								<input type="radio" name="layoutsettingssidebarposition" id="sidebarpositiontopstart" value="sidebarpositiontopstart" {if $themelayoutsetting.layoutsettingssidebarposition|default:''=='sidebarpositiontopstart'}checked{/if}>
				...
				<div style="margin-top: 0" class="form-group menu__place__radio__group white__radio__group">
					...
					<fieldset>
						<div class="radio">
							<label>
								<img src="../modules/addons/shufyTheme/assets/img/sidebar-logo-sidebar.webp" alt="">
								<input type="radio" name="layoutsettingssidebarstyle" id="sidebarsidebarlogo" value="sidebarsidebarlogo" {if $themelayoutsetting.layoutsettingssidebarstyle|default:''=='sidebarsidebarlogo' || $themelayoutsetting.id|default:'' != '1'}checked{/if}>
						...
						<div class="radio">
							<label>
								...
								<input type="radio" name="layoutsettingssidebarstyle" id="sidebarheaderlogo" value="sidebarheaderlogo" {if $themelayoutsetting.layoutsettingssidebarstyle|default:''=='sidebarheaderlogo'}checked{/if}>
