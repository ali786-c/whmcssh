<div class="alert alert-danger" role="alert">
  <h4 class="alert-heading">Envato Purchase Code is Used before!</h4>
  <p>Your purchase code is invalid! Plugin is not activated! Check your code – maybe it’s from another theme or your purchase code was previously used</p>
  <hr>
