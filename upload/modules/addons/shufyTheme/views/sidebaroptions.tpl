...
<div class="settings__popupalert__coodiv alert alert-success alert-dismissible show" role="alert">
  ...
  <div class="text">
  <strong>Success!</strong> Shufytheme Sidebar settings options has been reset successfully.
  </div>
...
<div class="settings__popupalert__coodiv alert alert-success alert-dismissible show" role="alert">
  ...
  <span class="icon"><i class="fal fa-check-circle"></i></span>
  <div class="text">
  <strong>Success!</strong> Shufytheme Sidebar settings options has been saved successfully.
  </div>
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
	<span aria-hidden="true">&times;</span>
  </button>
...
<div class="page__wrapper__content">
	<div class="coodiv__main__hero with__menu">
		...
		<ul class="navbar-nav coodiv__main__hero__nav">
		  ...
		  <li class="nav-item active"><a class="nav-link" >Sidebar</a></li>
	...
	<form id="applysidebaroptions" class="full__fieldset__area default__form__panel__cart coodiv__whmcs__admin__panel__form shufytheme__ajax__save" action="{$modurl}&action=applysidebaroptions" method="post">
		<div class="section">
			...
			<div class="form-group-wrapper-shadow">
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themesidebarsettingsdarkmode" id="themesidebarsettingsdarkmode">
						...
						<label class="template__label">
							<input type="checkbox" name="themesidebarsettingsdarkmode" id="themesidebarsettingsdarkmode" value="activated" {if $themesidebarsetting.themesidebarsettingsdarkmode|default:''=='activated' || $themesidebarsetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themesidebarsettingscollapsed" id="themesidebarsettingscollapsed">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themesidebarsettingscollapsed" id="themesidebarsettingscollapsed" value="activated" {if $themesidebarsetting.themesidebarsettingscollapsed|default:''=='activated' || $themesidebarsetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themesidebarsettingsallowusertoexpend" id="themesidebarsettingsallowusertoexpend">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themesidebarsettingsallowusertoexpend" id="themesidebarsettingsallowusertoexpend" value="activated" {if $themesidebarsetting.themesidebarsettingsallowusertoexpend|default:''=='activated' || $themesidebarsetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themesidebarsettingsallowusertocollapse" id="themesidebarsettingsallowusertocollapse">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themesidebarsettingsallowusertocollapse" id="themesidebarsettingsallowusertocollapse" value="activated" {if $themesidebarsetting.themesidebarsettingsallowusertocollapse|default:''=='activated' || $themesidebarsetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themesidebarsettingsfixedtopheader" id="themesidebarsettingsfixedtopheader">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themesidebarsettingsfixedtopheader" id="themesidebarsettingsfixedtopheader" value="activated" {if $themesidebarsetting.themesidebarsettingsfixedtopheader|default:''=='activated' || $themesidebarsetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themesidebarsettingsfixedhorizontalmenu" id="themesidebarsettingsfixedhorizontalmenu">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themesidebarsettingsfixedhorizontalmenu" id="themesidebarsettingsfixedhorizontalmenu" value="activated" {if $themesidebarsetting.themesidebarsettingsfixedhorizontalmenu|default:''=='activated' || $themesidebarsetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themesidebarsettingsfixedsecondarymenu" id="themesidebarsettingsfixedsecondarymenu">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themesidebarsettingsfixedsecondarymenu" id="themesidebarsettingsfixedsecondarymenu" value="activated" {if $themesidebarsetting.themesidebarsettingsfixedsecondarymenu|default:''=='activated' || $themesidebarsetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themesidebarsettingssidebaronhover" id="themesidebarsettingsfixedsecondarymenu">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themesidebarsettingssidebaronhover" id="themesidebarsettingssidebaronhover" value="activated" {if $themesidebarsetting.themesidebarsettingssidebaronhover|default:''=='activated' || $themesidebarsetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themesidebarsettingschildonhover" id="themesidebarsettingschildonhover">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themesidebarsettingschildonhover" id="themesidebarsettingschildonhover" value="activated" {if $themesidebarsetting.themesidebarsettingschildonhover|default:''=='activated' || $themesidebarsetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group templates__form__control d-none">
					...
					<fieldset name="themesidebarsettingsdarkicons" id="themesidebarsettingsdarkicons">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themesidebarsettingsdarkicons" id="themesidebarsettingsdarkicons" value="activated" {if $themesidebarsetting.themesidebarsettingsdarkicons|default:''=='activated' || $themesidebarsetting.id|default:'' != '1'}checked{/if}>
				...
				<div class="form-group templates__form__control d-none">
					...
					<fieldset name="themesidebarsettingswithouticons" id="themesidebarsettingswithouticons">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themesidebarsettingswithouticons" id="themesidebarsettingswithouticons" value="activated" {if $themesidebarsetting.themesidebarsettingswithouticons|default:''=='activated'}checked{/if}>
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themesidebarsettingfullwidthtopheader" id="themesidebarsettingfullwidthtopheader">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themesidebarsettingfullwidthtopheader" id="themesidebarsettingfullwidthtopheader" value="activated" {if $themesidebarsetting.themesidebarsettingfullwidthtopheader|default:''=='activated'}checked{/if}>
				...
				<div class="form-group templates__form__control">
					...
					<fieldset name="themesidebarsettingfullwithhorizontalmenu" id="themesidebarsettingfullwithhorizontalmenu">
						<div class="radio">
						<label class="template__label">
							<input type="checkbox" name="themesidebarsettingfullwithhorizontalmenu" id="themesidebarsettingfullwithhorizontalmenu" value="activated" {if $themesidebarsetting.themesidebarsettingfullwithhorizontalmenu|default:''=='activated'}checked{/if}>
